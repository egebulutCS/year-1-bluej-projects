...
public class NumberJudge
{
    ...
    {
        int number = reader.getInt("Please type a number?");
        showJudgement(number);
    }
    ...
    public void judgeInputSequence()
    {
        int number = 0;
        while (number>=0){
            number = reader.getInt("Please type a number?");
            showJudgement(number);
        }
    }
    ...
    public static void main(String[] args){
        for(int i = 0; i < args.length; i++){
            ...
            NumberJudge numberJudge = new NumberJudge(number);
            numberJudge.judgeInputSequence();
        }
    }
}
